...
namespace Oasez.Extensions
{
    public class ExtensionHelpers
    {
        ...
        public static IEnumerator LerpColor(Image currentRenderer, UnityEngine.Color targetColor, float speed)
        {
            ...
            //old position
            UnityEngine.Color rendererOldColor = currentRenderer.color;
            ...
            while (currentRenderer.color != targetColor)
            {
                try
                {
                    if (currentRenderer != null)
                        currentRenderer.color = UnityEngine.Color.Lerp(rendererOldColor, targetColor, (Time.time - time) * speed);
                    else
                        break;
                } catch (MissingReferenceException)
                {
        ...
        public static IEnumerator LerpColor(TextMeshProUGUI currentRenderer, UnityEngine.Color targetColor, float speed)
        {
            if (currentRenderer == null) yield return null;
