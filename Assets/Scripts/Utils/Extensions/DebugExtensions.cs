...
namespace Oasez.Extensions.Debugging {
    ...
    public static class DebugExtensions {
        ...
        public static void DrawBox(Vector3 center, Vector3 halfExtents, Quaternion orientation, UnityEngine.Color color, float duration) {
        ...
        public static void DrawArrow(Vector3 start, Vector3 dir, UnityEngine.Color color, float duration) {
